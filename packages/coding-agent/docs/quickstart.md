...
Platform notes: [Windows](windows.md), [Termux](termux.md), [tmux](tmux.md), [Devcontainer / Codespaces](devcontainer.md), [Terminal setup](terminal-setup.md), [Shell aliases](shell-aliases.md).
